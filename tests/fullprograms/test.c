/* Generated by Cython 0.16 on Thu Aug  9 14:20:43 2012 */
...
static PyObject *__pyx_f_4test_hi(void); /*proto*/
...
static PyObject *__pyx_f_4test_hi(void) {
 ...
 * hi()
 */
  if (__Pyx_PrintOne(0, ((PyObject *)__pyx_n_s__HI)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  __pyx_r = Py_None; __Pyx_INCREF(Py_None);
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("test.hi", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
 ...
 * hi()             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __pyx_f_4test_hi(); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
