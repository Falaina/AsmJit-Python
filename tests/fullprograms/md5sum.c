...
/*
 *  rfc1321 requires that I include this.  The code is new.  The
 *  constants
 *  all come from the rfc (hence the copyright).  We trade a table for
 *  the
 *  macros in rfc.  The total size is a lot less.
 *  presotto@plan9.bell-labs.com  (with tweaks by
